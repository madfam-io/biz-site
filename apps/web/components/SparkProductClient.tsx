...
interface SparkProductClientProps {
  locale: string;
  translations: {
    heroTitle: string;
    heroSubtitle: string;
...
export function SparkProductClient({
  locale,
  translations,
  features,
  useCases,
      ...
      >
        <div className="grid grid-cols-3 gap-8 text-center text-white/90">
          <div>
            ...
            <div className="text-sm">{translations.integrations}</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-sun">80%</div>
            <div className="text-sm">{translations.timeSaved}</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-sun">24/7</div>
            <div className="text-sm">{translations.support}</div>
          </div>
        </div>
      </Hero>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="text-gray-500">{translations.satisfaction}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
