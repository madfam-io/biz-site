  ...
  const useCases = [
    ...
    },
    {
      ...
      metrics: {
        reduction: '80%',
        time:
          currentLocale === 'en-US' ? '4 hours' : currentLocale === 'pt-BR' ? '4 horas' : '4 horas',
        satisfaction: '92%',
      },
      icon: '🎯',
    },
        ...
        subtitle={
          currentLocale === 'en-US'
            ...
            : currentLocale === 'pt-BR'
              ...
              : 'Plataforma de Orquestación de IA'
        }
        description={
          currentLocale === 'en-US'
            ? 'Connect, automate, and optimize all your business processes with artificial intelligence. A unified platform that transforms the way you work.'
            : currentLocale === 'pt-BR'
              ? 'Conecte, automatize e otimize todos os seus processos empresariais com inteligência artificial. Uma plataforma unificada que transforma a forma como você trabalha.'
              : 'Conecta, automatiza y optimiza todos tus procesos empresariales con inteligencia artificial. Una plataforma unificada que transforma la forma en que trabajas.'
        }
        cta={{
          primary: {
            text:
          ...
          <div className="text-center mb-16">
            <Heading level={2} className="mb-4">
              {currentLocale === 'en-US'
                ...
                : currentLocale === 'pt-BR'
                  ? 'Recursos poderosos para negócios modernos'
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              {currentLocale === 'en-US'
                ...
                : currentLocale === 'pt-BR'
                  ? 'SPARK fornece capacidades de nível empresarial com uma interface intuitiva, tornando a automação acessível para todos na sua organização.'
                  : 'SPARK proporciona capacidades de nivel empresarial con una interfaz intuitiva, haciendo la automatización accesible para todos en tu organización.'}
            </p>
          </div>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              {currentLocale === 'en-US'
                ...
                : currentLocale === 'pt-BR'
                  ? 'Veja como empresas como a sua estão usando SPARK para transformar suas operações e alcançar resultados notáveis.'
                  : 'Mira cómo empresas como la tuya están usando SPARK para transformar sus operaciones y lograr resultados notables.'}
            </p>
          </div>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              {currentLocale === 'en-US'
                ...
                : currentLocale === 'pt-BR'
                  ? 'Junte-se a centenas de empresas que transformaram suas operações com SPARK.'
                  : 'Únete a cientos de empresas que han transformado sus operaciones con SPARK.'}
            </p>
          </div>
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              {currentLocale === 'en-US'
                ...
                : currentLocale === 'pt-BR'
                  ? 'Comece com nosso plano Profissional ou obtenha uma solução Empresarial personalizada para sua organização.'
                  : 'Comienza con nuestro plan Profesional u obtén una solución Empresarial personalizada para tu organización.'}
            </p>
          </div>
              ...
              >
                ...
                <CardContent className="p-8">
                  ...
                  <Button
                    ...
                    className="w-full"
                    onClick={() =>
                      logServiceInquiry('L4_PLATFORMS', 'spark-pricing', {
                        plan: plan.name,
        ...
        <Container>
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <Heading level={2} className="mb-4">
                {currentLocale === 'en-US'
                  ? 'Calculate your SPARK ROI'
                  : currentLocale === 'pt-BR'
                    ? 'Calcule seu ROI do SPARK'
                    : 'Calcula tu ROI de SPARK'}
              </Heading>
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                {currentLocale === 'en-US'
                  ? 'See the potential impact SPARK can have on your business operations and bottom line.'
                  : currentLocale === 'pt-BR'
                    ? 'Veja o impacto potencial que SPARK pode ter em suas operações empresariais e resultado final.'
                    : 'Mira el impacto potencial que SPARK puede tener en tus operaciones empresariales y resultado final.'}
              </p>
            </div>
            ...
            <ROICalculator
              ...
              title={
                currentLocale === 'en-US'
                  ? 'SPARK ROI Calculator'
                  : currentLocale === 'pt-BR'
                    ? 'Calculadora ROI SPARK'
                    : 'Calculadora ROI SPARK'
              }
              onCalculate={results => {
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                {currentLocale === 'en-US'
                  ...
                  : currentLocale === 'pt-BR'
                    ? 'Veja SPARK em ação com uma demonstração personalizada baseada em seus casos de uso específicos e indústria.'
                    : 'Mira SPARK en acción con una demostración personalizada basada en tus casos de uso específicos e industria.'}
              </p>
            </div>
            ...
            <LeadForm
              ...
              description={
                currentLocale === 'en-US'
                  ...
                  : currentLocale === 'pt-BR'
                    ? 'Conte-nos sobre suas necessidades empresariais e personalizaremos a demonstração para mostrar exatamente como SPARK pode ajudar.'
                    : 'Cuéntanos sobre tus necesidades empresariales y personalizaremos la demostración para mostrar exactamente cómo SPARK puede ayudar.'
              }
              submitText={
                currentLocale === 'en-US'
                  ? 'Schedule demo'
            ...
            <Newsletter
              title={
                currentLocale === 'en-US'
                  ...
                  : currentLocale === 'pt-BR'
                    ? 'Mantenha-se atualizado com SPARK'
                    : 'Mantente actualizado con SPARK'
              }
              description={
                currentLocale === 'en-US'
                  ? 'Get the latest product updates, automation tips, and industry insights.'
                  : currentLocale === 'pt-BR'
                    ? 'Receba as últimas atualizações do produto, dicas de automação e insights da indústria.'
                    : 'Recibe las últimas actualizaciones del producto, consejos de automatización e insights de la industria.'
              }
              buttonText={
                currentLocale === 'en-US'
                  ? 'Subscribe'
