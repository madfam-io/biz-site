              ...
              <div className="text-center mb-12">
                <Heading level={2} className="mb-4">
                  {currentLocale === 'en-US'
                    ...
                    : currentLocale === 'pt-BR'
                      ? 'Receba sua estratégia personalizada'
                      : 'Recibe tu estrategia personalizada'}
                </Heading>
                <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                  {currentLocale === 'en-US'
                    ? "Based on your assessment results, we'll create a customized roadmap for your AI transformation journey."
                    : currentLocale === 'pt-BR'
                      ? 'Com base nos resultados da sua avaliação, criaremos um roteiro personalizado para sua jornada de transformação em IA.'
                      : 'Basándose en los resultados de tu evaluación, crearemos una hoja de ruta personalizada para tu viaje de transformación en IA.'}
                </p>
              </div>
              ...
              <LeadForm
                ...
                title={
                  currentLocale === 'en-US'
                    ...
                    : currentLocale === 'pt-BR'
                      ? 'Solicite sua sessão de estratégia'
                      : 'Solicita tu sesión de estrategia'
                }
                description={
                  currentLocale === 'en-US'
                    ? "Let's discuss your results and create a personalized plan for your AI transformation"
                    : currentLocale === 'pt-BR'
                      ? 'Vamos discutir seus resultados e criar um plano personalizado para sua transformação em IA'
                      : 'Vamos discutir tus resultados y crear un plan personalizado para tu transformación en IA'
                }
                submitText={
                  currentLocale === 'en-US'
        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-obsidian/70 mb-8">
              {currentLocale === 'en-US'
                ? "Discover your company's level of AI readiness and get personalized recommendations for your digital transformation journey."
                : currentLocale === 'pt-BR'
                  ? 'Descubra o nível de maturidade em IA da sua empresa e receba recomendações personalizadas para sua jornada de transformação digital.'
                  : 'Descubre el nivel de madurez en IA de tu empresa y recibe recomendaciones personalizadas para tu viaje de transformación digital.'}
            </p>
      ...
      <section className="section" id="assessment">
        <Container>
          <Assessment
            ...
            description={
              currentLocale === 'en-US'
                ? "Answer these strategic questions to understand your company's current AI maturity level"
                : currentLocale === 'pt-BR'
                  ? 'Responda estas perguntas estratégicas para entender o nível atual de maturidade em IA da sua empresa'
                  : 'Responde estas preguntas estratégicas para entender el nivel actual de madurez en IA de tu empresa'
            }
            ...
            <div className="text-center mb-12">
              <Heading level={2} className="mb-4">
                {currentLocale === 'en-US'
                  ...
                  : currentLocale === 'pt-BR'
                    ? 'Por que fazer a avaliação?'
                    : '¿Por qué hacer la evaluación?'}
              </Heading>
              <p className="text-lg text-obsidian/70">
                {currentLocale === 'en-US'
                  ? 'Get actionable insights to accelerate your AI transformation journey'
                  : currentLocale === 'pt-BR'
                    ? 'Obtenha insights acionáveis para acelerar sua jornada de transformação em IA'
                    : 'Obtén insights accionables para acelerar tu viaje de transformación en IA'}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center">
                <CardContent className="p-8">
                  ...
                  <p className="text-obsidian/70 text-sm">
                    {currentLocale === 'en-US'
                      ? 'Understand where your organization stands and what needs improvement'
                      : currentLocale === 'pt-BR'
                        ? 'Entenda onde sua organização está e o que precisa ser melhorado'
                        : 'Entiende dónde está tu organización y qué necesita mejora'}
                  </p>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-8">
                  ...
                  <h3 className="font-heading text-lg mb-2">
                    {currentLocale === 'en-US'
                      ? 'Benchmark Progress'
                      : currentLocale === 'pt-BR'
                        ? 'Referencie Progresso'
                        : 'Referencia Progreso'}
                  </h3>
                  <p className="text-obsidian/70 text-sm">
                    {currentLocale === 'en-US'
                      ? 'Compare your maturity level with industry standards and best practices'
                      : currentLocale === 'pt-BR'
                        ? 'Compare seu nível de maturidade com padrões da indústria e melhores práticas'
                        : 'Compara tu nivel de madurez con estándares de la industria y mejores prácticas'}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center">
                <CardContent className="p-8">
                  ...
                  <p className="text-obsidian/70 text-sm">
                    {currentLocale === 'en-US'
                      ? 'Receive personalized recommendations and next steps for your AI journey'
                      : currentLocale === 'pt-BR'
                        ? 'Receba recomendações personalizadas e próximos passos para sua jornada de IA'
                        : 'Recibe recomendaciones personalizadas y próximos pasos para tu viaje de IA'}
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="bg-gradient-to-r from-obsidian to-lavender rounded-3xl p-12 text-center text-white">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              {currentLocale === 'en-US'
                ...
                : currentLocale === 'pt-BR'
                  ? 'Faça a avaliação e descubra como MADFAM pode ajudá-lo a alcançar seus objetivos de transformação em IA'
                  : 'Haz la evaluación y descubre cómo MADFAM puede ayudarte a lograr tus objetivos de transformación en IA'}
            </p>
